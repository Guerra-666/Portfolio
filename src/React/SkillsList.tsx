...
const CategoryIcons = {
  'Desarrollo Backend': (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className='w-6 h-6 text-[var(--sec)] opacity-70'><path d="M4 5V19H20V7H11.5858L9.58579 5H4ZM12.4142 5H21C21.5523 5 22 5.44772 22 6V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H10.4142L12.4142 5Z"></path></svg>
  ),
  'Desarrollo Web': (
...
const SkillsList = () => {
  ...
  const skills = {
    ...
    'Desarrollo Web': [
      ...
      'Portafolios Web y Blogs',
    ],
    'Diseño y Prototipado UI/UX': [
      'Diseño de interfaces con Figma y Canva',
      'Prototipado para sitios y aplicaciones web ',
    ]
  };
